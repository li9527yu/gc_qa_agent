...
- `models/pose_landmarker_full.task`: MediaPipe 使用的姿态模型 | pose model used by MediaPipe
...
- 仓库中存在 `models/pose_landmarker_full.task` | `models/pose_landmarker_full.task` present in the repo
